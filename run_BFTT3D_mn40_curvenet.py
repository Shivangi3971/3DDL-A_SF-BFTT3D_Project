...
def main():
    ...
    if True:
        ...
        if True:    
            ...
            # source_model_path = f"checkpoint/{args.pth}_trained.pth"
            source_model_path = "checkpoint/curvenet.t7"
            ...
            try:
                try:
                    source_model.load_state_dict(torch.load(checkpoint))
                except:
                    source_model.load_state_dict(torch.load(checkpoint['model_state']))
            except:
